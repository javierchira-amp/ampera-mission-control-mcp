  ...
  () =>
    promptText(
      [
        ...
        "5. list_tasks with mine=true and status='WAITING' — what I'm waiting on others for.",
        "6. get_dashboard_summary — my role's KPI tiles (includes an overdueTasks count).",
        "",
        "Then brief me, in this order:",
        "- OVERDUE: open tasks past their dueDate — name each one.",
        "- WAITING ON: group the WAITING tasks by their Waiting:<name> tag — who owes",
        "  me what, flagging anything idle a week or more (updatedAt).",
        "- Review queue, notable dashboard signals, and a short prioritized focus",
        "  list for today.",
        "Don't change anything yet — just brief me. (The web equivalents: the",
        "dashboard's overdue card, and /tasks?view=waiting.)",
      ].join("\n"),
    ),
);
